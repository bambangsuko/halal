...
<div class="section-header-back">
    <a href="{{ route('cp.main-menus.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
</div>
<h1>Tambah Menu</h1>
...
@section('content')
<form action="{{ route('cp.main-menus.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                        ...
                        <select id="type" name="type" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}">
                            ...
                            <option value="dropdown" {{ old('type') ? (old('type') == 'dropdown' ? 'selected' : '') :  '' }}>Dropdown</option>
                        </select>
                    ...
                    <div class="form-group">
                      <label class="custom-switch mt-2 pl-0">
                        <input type="checkbox" name="is_homepage" class="custom-switch-input" {{ old('is_homepage') ? (old('is_homepage') == 'on' ? 'checked' : '') : '' }}>
                ...
                <div class="card-footer bg-whitesmoke">
                    ...
                    <a href="{{ route('cp.main-menus.index') }}" class="btn btn-secondary">
                        Batal
                    </a>
                </div>
            </div>
